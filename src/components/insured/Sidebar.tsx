...
import { Avatar } from "../broker/Avatar";
...
const mainNavItems: NavItem[] = [
  { label: "Dashboard", href: "/insured", icon: <LayoutDashboard size={20} /> },
  { label: "My Policies", href: "/insured/policies", icon: <Shield size={20} /> },
  { label: "Proposals", href: "/insured/proposals", icon: <ClipboardList size={20} /> },
  { label: "Endorsements", href: "/insured/endorsements", icon: <FileCheck size={20} /> },
  { label: "Certificates", href: "/insured/certificates", icon: <FileText size={20} /> },
  { label: "Claims", href: "/insured/claims", icon: <AlertTriangle size={20} /> },
  { label: "Billing", href: "/insured/billing", icon: <CreditCard size={20} /> },
];

const bottomNavItems: NavItem[] = [
  { label: "Settings", href: "/insured/settings", icon: <Settings size={20} /> },
  { label: "Help", href: "/insured/help", icon: <HelpCircle size={20} /> },
];

interface InsuredSidebarProps {
  user?: {
    name: string;
    email: string;
    avatar?: string;
...
export function InsuredSidebar({ user = { name: "Asheber Kebede", email: "asheber@safaritours.com" } }: InsuredSidebarProps) {
